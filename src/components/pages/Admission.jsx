  ...
  return (
    <div className="bg-white min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 relative z-10 flex flex-col items-start">
              ...
              <p className="text-slate-600 text-base sm:text-lg leading-relaxed mt-5 max-w-xl">
                Our admissions and enrolment details are currently being prepared, and we will share updates soon. In the meantime, our{' '}
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-md border-4 border-white">
                <img
                  ...
                  alt="Maple Leaf Montessori Daycare Admissions Coming Soon"
        ...
        {/* ================= SECTION 2: ADMISSIONS INFORMATION COMING SOON ================= */}
        <motion.div
          {...fadeUp}
        ...
        >
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto mt-6 leading-relaxed">
              We are preparing our admission details, enrolment information, and updates for families. Until then, families can explore our currently available Homecare Services.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 relative z-10">
            ...
            <div className="flex flex-col justify-between items-start relative pl-0 md:pl-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-base leading-relaxed mt-4 max-w-md">
                  While our daycare admissions are being prepared, our Homecare Services are available now for children, seniors, individuals, and households across Calgary.
                </p>
              </div>
